...
open class SQLiteBookmarks: BookmarksModelFactorySource, KeywordSearchSource {
    ...
    static let defaultFolderTitle: String = NSLocalizedString("BookmarkDefaultFolderName", tableName: "Storage", value: "Untitled", comment: "The default name for bookmark folders without titles.")
    static let defaultItemTitle: String = NSLocalizedString("BookmarkDefaultItemName", tableName: "Storage", value: "Untitled", comment: "The default name for bookmark nodes without titles.")
