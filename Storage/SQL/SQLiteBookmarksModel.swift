...
extension Strings {
    public static let SQLLiteBookmarkDesktopBookmarksLabel = NSLocalizedString("DesktopBookmarks", tableName: "Storage", value: "Desktop Bookmarks", comment: "The folder name for the virtual folder that contains all desktop bookmarks.")
    public static let SQLLiteBookmarkDefaultFolderTitle = NSLocalizedString("BookmarkDefaultFolderName", tableName: "Storage", value: "Untitled", comment: "The default name for bookmark folders without titles.")
    public static let SQLLiteBookmarkDefaultItemTitle = NSLocalizedString("BookmarkDefaultItemName", tableName: "Storage", value: "Untitled", comment: "The default name for bookmark nodes without titles.")
}
