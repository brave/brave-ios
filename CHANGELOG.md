...
- Implemented built-in iOS 16 find-in-page controls. ([#7238](https://github.com/brave/brave-ios/issues/7238))
...
- Resolved white screen issue when launching browser. ([#6444](https://github.com/brave/brave-ios/issues/6444))
...
- Fixed tabs from losing their order when restored or restored as white screen. ([#7366](https://github.com/brave/brave-ios/issues/7366))
...
- Fixed shields showing session restore data with reader mode enabled. ([#7103](https://github.com/brave/brave-ios/issues/7103))
- Fixed recent searches “show more” being cut off in some languages. ([#6824](https://github.com/brave/brave-ios/issues/6824))
