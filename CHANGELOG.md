...
- Fixed an issue with share menu only sharing the canonical(base) URL instead of the actual page URL. ([#4071](https://github.com/brave/brave-ios/issues/4071))
- Fixed an issue with Brave crashing in certain situations when history sync is enabled. ([#4073](https://github.com/brave/brave-ios/issues/4073))
...
- Fixed an issue where audio continues to play when opening and closing the menu. ([#4092](https://github.com/brave/brave-ios/issues/4092))
...
- Fixed an issue with tab appearing black when the subsequent tab is closed. ([#4149](https://github.com/brave/brave-ios/issues/4149))
