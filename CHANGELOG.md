...
- Fixed search feature on PDF file loaded on a webpage. ([#3312](https://github.com/brave/brave-ios/issues/3312))
...
- Disabled Shields from opening on new tab page. ([#4660](https://github.com/brave/brave-ios/issues/4660))
