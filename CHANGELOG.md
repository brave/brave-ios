...
- Implemented “Copy clean URL” feature on iOS. ([#6179](https://github.com/brave/brave-ios/issues/6179))
- Added support for Apple Screentime. ([#3939](https://github.com/brave/brave-ios/issues/3939))
- Added support for more regions for Brave News opt-in card. ([#7932](https://github.com/brave/brave-ios/issues/7932))
...
- Removed Zip Foundation dependency. ([#7901](https://github.com/brave/brave-ios/issues/7901))
- Removed a script on YouTube which caused ads to be shown. ([#8239](https://github.com/brave/brave-ios/issues/8239))
...
- Fixed app from crash when changing VPN regions after switching to IKEv2 protocol. ([#8235](https://github.com/brave/brave-ios/issues/8235))
