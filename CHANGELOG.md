...
## [1.13](https://github.com/brave/brave-ios/releases/tag/v1.13)
 ...
 - Implement Brave Rewards and Ads. ([#1920](https://github.com/brave/brave-ios/issues/1920))
 ...
 - Fixed wrong device name being shown when tapped on sync devices. ([#1587](https://github.com/brave/brave-ios/issues/1587))
 - Fixed readablity of website/tab names on dark mode. ([#1551](https://github.com/brave/brave-ios/issues/1551))
 - Fixed button border on Shields that were too light on light theme. ([#1548](https://github.com/brave/brave-ios/issues/1548))
 - Fixed missing long press context menu on image search results. ([#1547](https://github.com/brave/brave-ios/issues/1547))
 - Fixed "Download Cancelled" visibility on iOS 12 devices. ([#1516](https://github.com/brave/brave-ios/issues/1516))
