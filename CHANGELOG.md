...
- Removed network name from the “Public Encryption Key Request” panel. ([#7495](https://github.com/brave/brave-ios/issues/7495))
- Improved NFT importing in Brave Wallet by introducing a new button to add custom assets quicker in NFT tab view and also simplifying the “Add Custom Asset” form by moving moving “Token address” field to the top. ([#7556](https://github.com/brave/brave-ios/issues/7556))
- Updated “Select a Token to Send” screen to sort test network tokens to be displayed at the end. ([#7640](https://github.com/brave/brave-ios/issues/7640))
...
- Resolved migrating user assets when restoring from the wallet lock screen. ([#7785](https://github.com/brave/brave-ios/issues/7785))
- Resolved asset preferences from being overwritten when auto-discovery returns results. ([#7443](https://github.com/brave/brave-ios/issues/7443))
- Fixed auto-discovered assets from being duplicated after restoring Brave Wallet. ([#7804](https://github.com/brave/brave-ios/issues/7804))
- Fixed “Send” screen in Wallet to retain the last selected token when opened or display the native token by default. ([#7759](https://github.com/brave/brave-ios/issues/7759))
...
- Updated the Youtube setting strings in “Media” settings menu. ([#7776](https://github.com/brave/brave-ios/issues/7776))
- Updated the status bar overlay color to match the Brave UI in reader mode. ([#7673](https://github.com/brave/brave-ios/issues/7673))
- Updated the URL bar context menus to display operations in reverse order for “Bottom Bar” mode. ([#6260](https://github.com/brave/brave-ios/issues/6260))
...
- Fixed a crash relating to Brave Rewards when swiping to close app using the task switcher. ([#7690](https://github.com/brave/brave-ios/issues/7690))
