...
extension Strings {
    public static let AppAndDeviceNameFormat = NSLocalizedString("On", tableName: "Shared", value: "%@ on %@", comment: "A brief descriptive name for this app on this device, used for Send Tab and Synced Tabs. The first argument is the app name. The second argument is the device name.")
}
