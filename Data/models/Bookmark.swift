...
extension Bookmark {
    ...
    private func deleteInternal(save: Bool = true, sendToSync: Bool = true, context: WriteContext = .new(false)) {
...
extension Bookmark {
    ...
    func updateResolvedRecord(_ record: SyncRecord?, context: WriteContext = .new(false)) {
