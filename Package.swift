  ...
  targets: [
    ...
    .testTarget(
      ...
      resources: [
        ...
        .copy("Resources/html/cosmetic-filter-tests.html"),
        .copy("Resources/html/brave-player-tests.html"),
...
var braveTarget: PackageDescription.Target = .target(
  ...
  resources: [
    ...
    .copy("Frontend/Player/Player.css"),
    .copy("Frontend/Player/Player.js"),
    .copy("Frontend/Player/Player.html"),
    .copy("Frontend/Player/PlayerBackground.svg"),
    .copy("Frontend/Player/PlayerLogo.svg"),
