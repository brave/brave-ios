  ...
  public static func batchInsertIfNotExists(alerts: [BraveVPNAlertJSONModel]) {
    DataController.perform { context in
      guard let entity = entity(in: context) else {
        Log.main.error("Error fetching the entity 'BlockedResource' from Managed Object-Model")
  ...
  public static func allByHostCount(completion: @escaping (Set<CountableEntity>) -> Void) {
    ...
    DataController.perform { context in
      ...
      do {
        ...
        Log.main.error("allByHostCount error: \(error.localizedDescription)")
        completion(.init())
      }
    }
  }
  ...
  public static func alertTotals(completion:
    ...
    DataController.perform { context in
      ...
      do {
        ...
        Log.main.error("alertTotals error: \(error.localizedDescription)")
        completion((0, 0, 0))
      }
    }
  }
