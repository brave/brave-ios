...
public class DataController {
  ...
  private func storeURL(for directory: FileManager.SearchPathDirectory) -> URL {
    ...
    guard let docURL = urls.last else {
      Log.main.error("Could not load url for: \(directory.rawValue, privacy: .public)")
      fatalError()
    }
      ...
      queue.addOperation({
        ...
        backgroundContext.performAndWait {
          ...
          do {
            ...
            Log.main.error("performTask save error: \(error.localizedDescription, privacy: .public)")
          }
        }
      })
    }
