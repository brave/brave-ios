...
extension NetworkStore {
  ...
  static var previewStoreWithCustomNetworkAdded: NetworkStore {
    ...
    store.addCustomNetwork(.init(chainId: "0x100", chainName: "MockChain", blockExplorerUrls: ["https://mockchainscan.com"], iconUrls: [], rpcUrls: ["https://rpc.mockchain.com"], symbol: "MOCK", symbolName: "MOCK", decimals: 18, coin: .eth, isEip1559: false)) { _, _ in }
    return store
  }
}
