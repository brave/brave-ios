...
extension URL {
  public enum Brave {
    ...
    public static let braveLeoLinkReceiptProd = URL(string: "https://account.brave.com/?intent=connect-receipt&product=leo")!
    public static let braveLeoLinkReceiptStaging = URL(string: "https://account.bravesoftware.com/?intent=connect-receipt&product=leo")!
    public static let braveLeoLinkReceiptDev = URL(string: "https://account.brave.software/?intent=connect-receipt&product=leo")!
  }
  public enum Apple {
