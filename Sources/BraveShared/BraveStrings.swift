...
extension Strings {
  ...
  public static let addCustomFilterListWarning = NSLocalizedString("AddCustomFilterListWarning", tableName: "BraveShared", bundle: .module, value: "Only subscribe to lists from entities you trust.", comment: "Warning text found in the footer of the add custom filter list url screen.")
  public static let addCustomFilterListWarning2 = NSLocalizedString("AddCustomFilterListWarning2", tableName: "BraveShared", bundle: .module, value: "Your browser will periodically check for list updates from the URL you enter.", comment: "Additional warning text found in the footer of the add custom filter list url screen.")
  public static let filterListsLastUpdatedLabel = NSLocalizedString("FilterListsLastUpdatedLabel", tableName: "BraveShared", bundle: .module, value: "Last Updated", comment: "A label in front of a last updated date for custom filter lists")
