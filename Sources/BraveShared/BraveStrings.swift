...
extension Strings {
  ...
  public static let tabsOptionBottomBar = NSLocalizedString("SettingsTabsOptionTopBar", tableName: "BraveShared", bundle: .strings, value: "Bottom Bar", comment: "An option for the URL bar position. (Top Bar and Bottom Bar). Refers to the location of the url bar")
