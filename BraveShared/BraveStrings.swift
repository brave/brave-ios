...
// MARK: - Onboarding
extension Strings {
    public static let Open = NSLocalizedString("BraveRewardsOpen", bundle: Bundle.braveShared, value: "Open", comment: "")
    public static let AdNotificationTitle = NSLocalizedString("BraveRewardsAdNotificationTitle", bundle: Bundle.braveShared, value: "Advertisement", comment: "")
    public static let Verified = NSLocalizedString("BraveRewardsVerified", bundle: Bundle.braveShared, value: "Brave Verified Publisher", comment: "")
    public static let CheckAgain = NSLocalizedString("BraveRewardsCheckAgain", bundle: Bundle.braveShared, value: "Refresh Status", comment: "")
    public static let RewardsOptInLearnMore = NSLocalizedString("RewardsOptInLearnMore", bundle: Bundle.braveShared, value: "Learn More", comment: "")
    public static let SettingsAdsBody = NSLocalizedString("BraveRewardsSettingsAdsBody", bundle: Bundle.braveShared, value: "Earn tokens by viewing ads in Brave. Ads presented are based on your interests, as inferred from your browsing behavior. No personal data or browsing history ever leaves your browser.", comment: "")
    public static let WalletHeaderGrants = NSLocalizedString("BraveRewardsWalletHeaderGrants", bundle: Bundle.braveShared, value: "Grants", comment: "")
    public static let SettingsTitle = NSLocalizedString("BraveRewardsSettingsTitle", bundle: Bundle.braveShared, value: "Settings", comment: "")
    public static let Tips = NSLocalizedString("BraveRewardsTips", bundle: Bundle.braveShared, value: "Tips", comment: "")
    public static let SettingsAutoContributeTitle = NSLocalizedString("BraveRewardsSettingsAutoContributeTitle", bundle: Bundle.braveShared, value: "Auto-Contribute", comment: "")
    public static let NotYetVerified = NSLocalizedString("BraveRewardsNotYetVerified", bundle: Bundle.braveShared, value: "Not yet verified", comment: "")
    public static let GrantsClaimedTitle = NSLocalizedString("BraveRewardsGrantsClaimedTitle", bundle: Bundle.braveShared, value: "It's your lucky day!", comment: "")
    public static let NotificationAdsTitle = NSLocalizedString("BraveRewardsNotificationAdsTitle", bundle: Bundle.braveShared, value: "Brave Ads", comment: "")
    public static let MinimumVisitsChoices2 = NSLocalizedString("BraveRewardsMinimumVisitsChoices2", bundle: Bundle.braveShared, value: "10 visits", comment: "")
    public static let MinimumVisitsChoices1 = NSLocalizedString("BraveRewardsMinimumVisitsChoices1", bundle: Bundle.braveShared, value: "5 visits", comment: "")
    public static let MinimumVisitsChoices0 = NSLocalizedString("BraveRewardsMinimumVisitsChoices0", bundle: Bundle.braveShared, value: "1 visit", comment: "")
    public static let AddFundsVCTitle = NSLocalizedString("BraveRewardsAddFundsVCTitle", bundle: Bundle.braveShared, value: "Add Funds", comment: "")
    public static let AddFundsTitle = NSLocalizedString("BraveRewardsAddFundsTitle", bundle: Bundle.braveShared, value: "Send cryptocurrency from your external account to your Brave Rewards wallet.", comment: "")
    public static let NotificationAutoContributeTitle = NSLocalizedString("BraveRewardsNotificationAutoContributeTitle", bundle: Bundle.braveShared, value: "Auto-Contribute", comment: "")
    public static let AddFunds = NSLocalizedString("BraveRewardsAddFunds", bundle: Bundle.braveShared, value: "Add Funds", comment: "")
    public static let EmptyTipsText = NSLocalizedString("BraveRewardsEmptyTipsText", bundle: Bundle.braveShared, value: "Have you tipped your favorite content creator today?", comment: "")
    public static let AutoContributeMinimumVisits = NSLocalizedString("BraveRewardsAutoContributeMinimumVisits", bundle: Bundle.braveShared, value: "Minimum Visits", comment: "")
    public static let AddFundsShowQRCode = NSLocalizedString("BraveRewardsAddFundsShowQRCode", bundle: Bundle.braveShared, value: "Show QR Code", comment: "")
    public static let RewardsOptInPrefix = NSLocalizedString("RewardsOptInPrefix", bundle: Bundle.braveShared, value: "Get ready to experience the next Internet.", comment: "")
    public static let DisclaimerLearnMore = NSLocalizedString("BraveRewardsDisclaimerLearnMore", bundle: Bundle.braveShared, value: "Learn More", comment: "")
    public static let CLAIM = NSLocalizedString("CLAIM", bundle: Bundle.braveShared, value: "CLAIM", comment: "")
    public static let AutoContributeNextDate = NSLocalizedString("BraveRewardsAutoContributeNextDate", bundle: Bundle.braveShared, value: "Next contribution date", comment: "")
    public static let TippingMakeMonthly = NSLocalizedString("BraveRewardsTippingMakeMonthly", bundle: Bundle.braveShared, value: "Make this monthly", comment: "")
    public static let OK = NSLocalizedString("OK", bundle: Bundle.braveShared, value: "OK", comment: "")
    public static let LearnMoreHowItWorks = NSLocalizedString("BraveRewardsLearnMoreHowItWorks", bundle: Bundle.braveShared, value: "How it works…", comment: "")
    public static let GrantListExpiresOn = NSLocalizedString("BraveRewardsGrantListExpiresOn", bundle: Bundle.braveShared, value: "Expires on %@", comment: "")
    public static let AutoContribute = NSLocalizedString("BraveRewardsAutoContribute", bundle: Bundle.braveShared, value: "Auto-Contribute", comment: "")
    public static let PoweredByUphold = NSLocalizedString("BraveRewardsPoweredByUphold", bundle: Bundle.braveShared, value: "Your Brave wallet is powered by Uphold", comment: "")
    public static let AddFundsBody = NSLocalizedString("BraveRewardsAddFundsBody", bundle: Bundle.braveShared, value: "Be sure to use the address below that matches the type of crypto you own. It will be converted automatically to BAT by Uphold and appear as an increased balance in your Brave Rewards wallet. Please allow up to one hour for your wallet balance to update.", comment: "")
    public static let Site = NSLocalizedString("BraveRewardsSite", bundle: Bundle.braveShared, value: "Site", comment: "")
    public static let TotalSites = NSLocalizedString("BraveRewardsTotalSites", bundle: Bundle.braveShared, value: "Total %ld", comment: "")
    public static let EmptyWalletBulletHeader = NSLocalizedString("BraveRewardsEmptyWalletBulletHeader", bundle: Bundle.braveShared, value: "3 ways to fill your wallet:", comment: "")
    public static let BraveRewards = NSLocalizedString("BraveRewards", bundle: Bundle.braveShared, value: "Brave Rewards™", comment: "")
    public static let PublisherSendTip = NSLocalizedString("BraveRewardsPublisherSendTip", bundle: Bundle.braveShared, value: "Send a tip…", comment: "")
    public static let TippingWalletBalanceTitle = NSLocalizedString("BraveRewardsTippingWalletBalanceTitle", bundle: Bundle.braveShared, value: "wallet balance", comment: "")
    public static let LearnMoreSubtitle = NSLocalizedString("BraveRewardsLearnMoreSubtitle", bundle: Bundle.braveShared, value: "Get Rewarded for Browsing!", comment: "")
    public static let TippingAmountTitle = NSLocalizedString("BraveRewardsTippingAmountTitle", bundle: Bundle.braveShared, value: "Tip amount", comment: "")
    public static let MinimumLengthChoices2 = NSLocalizedString("BraveRewardsMinimumLengthChoices2", bundle: Bundle.braveShared, value: "1 minute", comment: "")
    public static let MinimumLengthChoices1 = NSLocalizedString("BraveRewardsMinimumLengthChoices1", bundle: Bundle.braveShared, value: "8 seconds", comment: "")
    public static let MinimumLengthChoices0 = NSLocalizedString("BraveRewardsMinimumLengthChoices0", bundle: Bundle.braveShared, value: "5 seconds", comment: "")
    public static let SettingsAdsTitle = NSLocalizedString("BraveRewardsSettingsAdsTitle", bundle: Bundle.braveShared, value: "Ads", comment: "")
    public static let NotificationRecurringTipTitle = NSLocalizedString("BraveRewardsNotificationRecurringTipTitle", bundle: Bundle.braveShared, value: "Recurring tips", comment: "")
    public static let EmptyWalletTitle = NSLocalizedString("BraveRewardsEmptyWalletTitle", bundle: Bundle.braveShared, value: "Sadly, no tokens yet.", comment: "")
    public static let RecurringTipTitle = NSLocalizedString("BraveRewardsRecurringTipTitle", bundle: Bundle.braveShared, value: "Recurring tip", comment: "")
    public static let UnverifiedPublisherDisclaimer = NSLocalizedString("BraveRewardsUnverifiedPublisherDisclaimer", bundle: Bundle.braveShared, value: "This creator has not yet signed up to receive contributions from Brave users. Any tips you send will remain in your wallet until they verify.", comment: "")
    public static let SettingsGrantClaimButtonTitle = NSLocalizedString("BraveRewardsSettingsGrantClaimButtonTitle", bundle: Bundle.braveShared, value: "Claim", comment: "")
    public static let AutoContributeMinimumLength = NSLocalizedString("BraveRewardsAutoContributeMinimumLength", bundle: Bundle.braveShared, value: "Minimum Length", comment: "")
    public static let AutoContributeMinimumVisitsMessage = NSLocalizedString("BraveRewardsAutoContributeMinimumVisitsMessage", bundle: Bundle.braveShared, value: "Minimum visits for publisher relevancy", comment: "")
    public static let AutoContributeMinimumLengthMessage = NSLocalizedString("BraveRewardsAutoContributeMinimumLengthMessage", bundle: Bundle.braveShared, value: "Minimum page time before logging a visit", comment: "")
    public static let NotificationTokenGrantTitle = NSLocalizedString("BraveRewardsNotificationTokenGrantTitle", bundle: Bundle.braveShared, value: "Token Grants", comment: "")
    public static let LearnMoreBraveAdsBody = NSLocalizedString("BraveRewardsLearnMoreBraveAdsBody", bundle: Bundle.braveShared, value: "Get paid to view relevant ads that respect your privacy.", comment: "")
    public static let AutoContributeToUnverifiedSites = NSLocalizedString("BraveRewardsAutoContributeToUnverifiedSites", bundle: Bundle.braveShared, value: "Allow contribution to non-verified sites", comment: "")
    public static let LearnMoreWhyTitle = NSLocalizedString("BraveRewardsLearnMoreWhyTitle", bundle: Bundle.braveShared, value: "Why Brave Rewards?", comment: "")
    public static let Attention = NSLocalizedString("BraveRewardsAttention", bundle: Bundle.braveShared, value: "Attention", comment: "")
    public static let Exclude = NSLocalizedString("BraveRewardsExclude", bundle: Bundle.braveShared, value: "Exclude", comment: "")
    public static let AutoContributeSupportedSites = NSLocalizedString("BraveRewardsAutoContributeSupportedSites", bundle: Bundle.braveShared, value: "Supported sites", comment: "")
    public static let LearnMoreTurnOnRewardsTitle = NSLocalizedString("BraveRewardsLearnMoreTurnOnRewardsTitle", bundle: Bundle.braveShared, value: "Activate Rewards", comment: "")
    public static let SettingsDisabledTitle1 = NSLocalizedString("BraveRewardsSettingsDisabledTitle1", bundle: Bundle.braveShared, value: "Why Brave Rewards?", comment: "")
    public static let SettingsDisabledTitle2 = NSLocalizedString("BraveRewardsSettingsDisabledTitle2", bundle: Bundle.braveShared, value: "Today, Brave welcomes you to the new internet.", comment: "")
    public static let SummaryTitle = NSLocalizedString("BraveRewardsSummaryTitle", bundle: Bundle.braveShared, value: "Rewards Summary", comment: "")
    public static let SettingsGrantText = NSLocalizedString("BraveRewardsSettingsGrantText", bundle: Bundle.braveShared, value: "A free token grant is available.", comment: "")
    public static let SettingsAdsGrantText = NSLocalizedString("BraveRewardsSettingsAdsGrantText", bundle: Bundle.braveShared, value: "earned from ads", comment: "Example: <10 BAT> earned from ads")
    public static let SettingsAdsGrantAmountText = NSLocalizedString("BraveRewardsSettingsAdsGrantAmountText", bundle: Bundle.braveShared, value: "Your Ads earnings, %@ are available.", comment: "")
    public static let Grants = NSLocalizedString("BraveRewardsGrants", bundle: Bundle.braveShared, value: "Grants", comment: "")
    public static let LearnMoreTipsBody = NSLocalizedString("BraveRewardsLearnMoreTipsBody", bundle: Bundle.braveShared, value: "Support your favorite sites just by browsing – or tip a site any time you like.", comment: "")
    public static let WalletDetailsTitle = NSLocalizedString("BraveRewardsWalletDetailsTitle", bundle: Bundle.braveShared, value: "Wallet Details", comment: "")
    public static let GrantsClaimedSubtitle = NSLocalizedString("BraveRewardsGrantsClaimedSubtitle", bundle: Bundle.braveShared, value: "Your token grant is on its way.", comment: "")
    public static let AutoContributeRestoreExcludedSites = NSLocalizedString("BraveRewardsAutoContributeRestoreExcludedSites", bundle: Bundle.braveShared, value: "Restore %ld excluded sites", comment: "")
    public static let SettingsViewDetails = NSLocalizedString("BraveRewardsSettingsViewDetails", bundle: Bundle.braveShared, value: "View Details", comment: "")
    public static let AutoContributeMonthlyPaymentTitle = NSLocalizedString("BraveRewardsAutoContributeMonthlyPayment", bundle: Bundle.braveShared, value: "Monthly Payment", comment: "")
    public static let AutoContributeMonthlyPayment = NSLocalizedString("BraveRewardsAutoContributeMonthlyPayment", bundle: Bundle.braveShared, value: "Monthly payment", comment: "")
    public static let Tokens = NSLocalizedString("BraveRewardsTokens", bundle: Bundle.braveShared, value: "Tokens", comment: "")
    public static let LearnMoreTurnOnRewardsBody = NSLocalizedString("BraveRewardsLearnMoreTurnOnRewardsBody", bundle: Bundle.braveShared, value: "This enables both ads and automatic contributions. You can turn them on or off separately at any time.", comment: "")
    public static let TippingNotEnoughTokens = NSLocalizedString("BraveRewardsTippingNotEnoughTokens", bundle: Bundle.braveShared, value: "Not enough tokens. Please add funds.", comment: "")
    public static let TippingOverviewTitle = NSLocalizedString("BraveRewardsTippingOverviewTitle", bundle: Bundle.braveShared, value: "Welcome!", comment: "")
    public static let LearnMoreTipsTitle = NSLocalizedString("BraveRewardsLearnMoreTipsTitle", bundle: Bundle.braveShared, value: "Auto-Contribute", comment: "")
    public static let TippingConfirmation = NSLocalizedString("BraveRewardsTippingConfirmation", bundle: Bundle.braveShared, value: "Thank you", comment: "")
    public static let TippingMonthlyTitle = NSLocalizedString("BraveRewardsTippingTitle", bundle: Bundle.braveShared, value: "You are automatically sending a tip to:", comment: "")
    public static let TippingOneTimeTitle = NSLocalizedString("BraveRewardsTippingOneTimeTitle", bundle: Bundle.braveShared, value: "You've just sent a tip to:", comment: "")
    public static let TippingRecurring = NSLocalizedString("BraveRewardsTippingRecurring", bundle: Bundle.braveShared, value: "Monthly", comment: "")
    public static let TippingRecurringDetails = NSLocalizedString("BraveRewardsTippingRecurringDetails", bundle: Bundle.braveShared, value: "Your first monthly tip will be sent on:", comment: "")
    public static let DisabledBody = NSLocalizedString("BraveRewardsDisabledBody", bundle: Bundle.braveShared, value: "Earn by viewing privacy-respecting ads, and pay it forward to support content creators you love.", comment: "")
    public static let LearnMoreCreateWallet2 = NSLocalizedString("BraveRewardsLearnMoreCreateWallet2", bundle: Bundle.braveShared, value: "Yes I'm Ready!", comment: "")
    public static let DisabledTitle = NSLocalizedString("BraveRewardsDisabledTitle", bundle: Bundle.braveShared, value: "Welcome Back!", comment: "")
    public static let LearnMoreCreateWallet1 = NSLocalizedString("BraveRewardsLearnMoreCreateWallet1", bundle: Bundle.braveShared, value: "Yes, I'm In!", comment: "")
    public static let LearnMoreBraveAdsTitle = NSLocalizedString("BraveRewardsLearnMoreBraveAdsTitle", bundle: Bundle.braveShared, value: "Ads", comment: "")
    public static let TippingUnverifiedDisclaimer = NSLocalizedString("BraveRewardsTippingUnverifiedDisclaimer", bundle: Bundle.braveShared, value: "NOTE: This creator has not yet signed up to receive contributions from Brave users. Your browser will keep trying to contribute until they verify, or until 90 days have passed.", comment: "")
    public static let SettingsTipsBody = NSLocalizedString("BraveRewardsSettingsTipsBody", bundle: Bundle.braveShared, value: "Tip content creators directly as you browse. You can also set up recurring monthly tips so you can support sites continuously.", comment: "")
    public static let Cancel = NSLocalizedString("Cancel", bundle: Bundle.braveShared, value: "Cancel", comment: "")
    public static let DisabledSubtitle = NSLocalizedString("BraveRewardsDisabledSubtitle", bundle: Bundle.braveShared, value: "Get Rewarded for Browsing!", comment: "")
    public static let EmptyAutoContribution = NSLocalizedString("BraveRewardsEmptyAutoContribution", bundle: Bundle.braveShared, value: "Sites will appear as you browse", comment: "")
    public static let LearnMoreBody = NSLocalizedString("BraveRewardsLearnMoreBody", bundle: Bundle.braveShared, value: "Your attention is valuable. Earn by viewing privacy-respecting ads, and pay it forward to support content creators you love.", comment: "")
    public static let RewardsOptInJoinTitle = NSLocalizedString("RewardsOptInJoinTitle", bundle: Bundle.braveShared, value: "Join Rewards", comment: "")
    public static let DisclaimerInformation = NSLocalizedString("DisclaimerInformation", bundle: Bundle.braveShared, value: "By clicking 'Join Rewards', you indicate that you have read and agree to the Terms of Service and Privacy Policy.", comment: "")
    public static let WelcomeDisclaimerInformation = NSLocalizedString("WelcomeDisclaimerInformation", bundle: Bundle.braveShared, value: "By clicking 'Yes, I'm in!', you indicate that you have read and agree to the Terms of Service and Privacy Policy.", comment: "")
    public static let TermsOfServiceURL = NSLocalizedString("TermsOfServiceURL", bundle: Bundle.braveShared, value: "Terms of Service", comment: "")
    public static let PrivacyPolicyURL = NSLocalizedString("PrivacyPolicyURL", bundle: Bundle.braveShared, value: "Privacy Policy", comment: "")
    public static let AddFundsTokenWalletAddress = NSLocalizedString("BraveRewardsAddFundsTokenWalletAddress", bundle: Bundle.braveShared, value: "Wallet Address", comment: "")
    public static let AutoContributeToVideos = NSLocalizedString("BraveRewardsAutoContributeToVideos", bundle: Bundle.braveShared, value: "Allow contribution to videos", comment: "")
    public static let SettingsDisabledBody2 = NSLocalizedString("BraveRewardsSettingsDisabledBody2", bundle: Bundle.braveShared, value: "One where your time is valued, your personal data is kept private, and you actually get paid for your attention.", comment: "")
    public static let ContributingToUnverifiedSites = NSLocalizedString("BraveRewardsContributingToUnverifiedSites", bundle: Bundle.braveShared, value: "You've designated %@ BAT for creators who haven't yet signed up to recieve contributions. Your browser will keep trying to contribute until they verify, or until 90 days have passed.", comment: "")
    public static let SettingsDisabledBody1 = NSLocalizedString("BraveRewardsSettingsDisabledBody1", bundle: Bundle.braveShared, value: "With your old browser, you paid to browse the web by viewing ads with your valuable attention. You spent your valuable time downloading invasive ad technology that transmitted your valuable private data to advertisers — without your consent.", comment: "")
    public static let PanelTitle = NSLocalizedString("BraveRewardsPanelTitle", bundle: Bundle.braveShared, value: "Rewards", comment: "")
    public static let CreatingWallet = NSLocalizedString("BraveRewardsCreatingWallet", bundle: Bundle.braveShared, value: "Creating wallet", comment: "")
    public static let RewardsOptInDescription = NSLocalizedString("RewardsOptInDescription", bundle: Bundle.braveShared, value: "You can now earn tokens for watching privacy-respecting ads.", comment: "")
    public static let WalletHeaderTitle = NSLocalizedString("BraveRewardsWalletHeaderTitle", bundle: Bundle.braveShared, value: "Your wallet", comment: "")
    public static let TipsTotalThisMonth = NSLocalizedString("BraveRewardsTipsTotalThisMonth", bundle: Bundle.braveShared, value: "Total tips this month", comment: "")
    public static let TippingTitle = NSLocalizedString("BraveRewardsTippingTitle", bundle: Bundle.braveShared, value: "Send a tip", comment: "")
    public static let GrantsClaimedExpirationDateTitle = NSLocalizedString("BraveRewardsGrantsClaimedExpirationDateTitle", bundle: Bundle.braveShared, value: "Grant Expiration Date", comment: "")
    public static let SettingsAutoContributeBody = NSLocalizedString("BraveRewardsSettingsAutoContributeBody", bundle: Bundle.braveShared, value: "An automatic way to support publishers and content creators. Set a monthly payment and browse normally. The sites you visit receive your contributions automatically, based on your attention as measured by Brave.", comment: "")
    public static let GrantsClaimedAmountTitle = NSLocalizedString("BraveRewardsGrantsClaimedAmountTitle", bundle: Bundle.braveShared, value: "Free Token Grant", comment: "")
    public static let SettingsAdsComingSoonText = NSLocalizedString("BraveRewardsSettingsAdsComingSoonText", bundle: Bundle.braveShared, value: "Coming soon.", comment: "")
    public static let SettingsTipsTitle = NSLocalizedString("BraveRewardsSettingsTipsTitle", bundle: Bundle.braveShared, value: "Tips", comment: "")
    public static let AddFundsDisclaimer = NSLocalizedString("BraveRewardsAddFundsDisclaimer", bundle: Bundle.braveShared, value: "Reminder: The Brave Wallet is unidirectional and BAT flows to publisher sites. For more information about Brave Rewards, please visit the FAQ.", comment: "")
    public static let LearnMoreReady = NSLocalizedString("BraveRewardsLearnMoreReady", bundle: Bundle.braveShared, value: "Ready to get started?", comment: "")
    public static let Remove = NSLocalizedString("BraveRewardsRemove", bundle: Bundle.braveShared, value: "Remove", comment: "")
    public static let LearnMoreWhyBody = NSLocalizedString("BraveRewardsLearnMoreWhyBody", bundle: Bundle.braveShared, value: "With your old browser, you paid to browse the web by viewing ads with your valuable attention. You spent your valuable time downloading invasive ad technology that transmitted your valuable private data to advertisers — without your consent.\n\nToday, Brave welcomes you to the new Internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.", comment: "")
    public static let DisabledEnableButton = NSLocalizedString("BraveRewardsDisabledEnableButton", bundle: Bundle.braveShared, value: "Enable Brave Rewards", comment: "")
    public static let EmptyWalletBulletPoints = NSLocalizedString("BraveRewardsEmptyWalletBulletPoints", bundle: Bundle.braveShared, value: "• You can add funds.\n• You can earn tokens from viewing ads.\n• Occasionally, you'll be offered free token grants from Brave. Be sure to keep an eye out for the alert!", comment: "")
    public static let TippingOverviewBody = NSLocalizedString("BraveRewardsTippingOverviewBody", bundle: Bundle.braveShared, value: "You can support this content creator by sending a tip. It’s a way of thanking them for making great content. Verified creators get paid for their tips during the first week of each calendar month.\n\nIf you like, you can schedule monthly tips to support this creator on a continuous basis.", comment: "")
    public static let TippingSendTip = NSLocalizedString("BraveRewardsTippingSendTip", bundle: Bundle.braveShared, value: "Send my Tip", comment: "")
    public static let TippingSendMonthlyTip = NSLocalizedString("BraveRewardsTippingSendMonthlyTip", bundle: Bundle.braveShared, value: "Set monthly tip", comment: "")
    public static let NoActivitiesYet = NSLocalizedString("BraveRewardsNoActivitiesYet", bundle: Bundle.braveShared, value: "No activities yet…", comment: "")
    public static let AdsMaxPerHour = NSLocalizedString("BraveRewardsAdsMaxPerDay", bundle: Bundle.braveShared, value: "Maximum number of ads displayed", comment: "")
    public static let NumberOfAdsPerHourOptionsTitle = NSLocalizedString("BraveRewardsNumberOfAdsPerHourOptionsTitle", bundle: Bundle.braveShared, value: "Ads per hour", comment: "")
    public static let AdsEstimatedEarnings = NSLocalizedString("BraveRewardsAdsEstimatedEarnings", bundle: Bundle.braveShared, value: "Estimated pending rewards", comment: "")
    public static let NextPaymentDate = NSLocalizedString("BraveRewardsPaymentDate", bundle: Bundle.braveShared, value: "Next payment date", comment: "")
    public static let AdNotificationsReceived = NSLocalizedString("BraveRewardsAdNotificationsReceived", bundle: Bundle.braveShared, value: "Ad notifications received this month", comment: "")
    public static let OneAdPerHour = NSLocalizedString("BraveRewardsOneAdPerHour", bundle: Bundle.braveShared, value: "1 ad per hour", comment: "")
    public static let TwoAdsPerHour = NSLocalizedString("BraveRewardsTwoAdsPerHour", bundle: Bundle.braveShared, value: "2 ads per hour", comment: "")
    public static let ThreeAdsPerHour = NSLocalizedString("BraveRewardsThreeAdsPerHour", bundle: Bundle.braveShared, value: "3 ads per hour", comment: "")
    public static let FourAdsPerHour = NSLocalizedString("BraveRewardsFourAdsPerHour", bundle: Bundle.braveShared, value: "4 ads per hour", comment: "")
    public static let FiveAdsPerHour = NSLocalizedString("BraveRewardsFiveAdsPerHour", bundle: Bundle.braveShared, value: "5 ads per hour", comment: "")
    public static let AdsPayoutDateFormat = NSLocalizedString("BraveRewardsAdsPayoutDateFormat", bundle: Bundle.braveShared, value: "MMM d", comment: "")
    public static let TotalGrantsClaimed = NSLocalizedString("BraveRewardsTotalGrantsClaimed", bundle: Bundle.braveShared, value: "Token Grants Claimed", comment: "")
    public static let EarningFromAds = NSLocalizedString("BraveRewardsEarningFromAds", bundle: Bundle.braveShared, value: "Earnings from Ads", comment: "")
    public static let OneTimeTips = NSLocalizedString("BraveRewardsOneTimeTips", bundle: Bundle.braveShared, value: "One-time Tips", comment: "")
    public static let MonthlyTips = NSLocalizedString("BraveRewardsMonthlyTips", bundle: Bundle.braveShared, value: "Monthly Tips", comment: "")
    public static let AdsUnsupportedRegion = NSLocalizedString("BraveRewardsAdsUnsupportedRegion", bundle: Bundle.braveShared, value: "Sorry! Ads are not yet available in your region.", comment: "")
    public static let AdsUnsupportedDevice = NSLocalizedString("BraveRewardsAdsUnsupportedDvice", bundle: Bundle.braveShared, value: "Brave Rewards and Ads are not available on your device at this time.", comment: "")
    public static let AutoContributeSwitchLabel = NSLocalizedString("AutoContributeSwitchLabel", bundle: Bundle.braveShared, value: "Auto-Contribute", comment: "Label for auto-contribute toggle.")
    public static let TipSiteMonthly = NSLocalizedString("TipSiteMonthly", bundle: Bundle.braveShared, value: "Tip this site monthly", comment: "")
    public static let OneTimeText = NSLocalizedString("OneTimeText", bundle: Bundle.braveShared, value: "One time ", comment: "Text describing the type of contribution")
    public static let RecurringText = NSLocalizedString("RecurringText", bundle: Bundle.braveShared, value: "Recurring", comment: "Text describing the type of contribution")
    public static let OnProviderText = NSLocalizedString("OnProviderText", bundle: Bundle.braveShared, value: "on %@", comment: "This is a suffix statement. example: SomeChannel on Twitter")
    public static let NotificationInsufficientFundsTitle = NSLocalizedString("NotificationInsufficientFundsTitle", bundle: Bundle.braveShared, value: "Insufficient Funds", comment: "Title for insufficient funds notification")
    public static let TurnOnAds = NSLocalizedString("TurnOnAds", bundle: Bundle.braveShared, value: "Turn on Ads", comment: "Prompt to turn on Ads via notification")
    public static let NotificationPendingContributionTitle = NSLocalizedString("NotificationPendingContributionTitle", bundle: Bundle.braveShared, value: "Pending Contribution", comment: "Notification title for pending contribution type")
    public static let NotificationTipsProcessedBody = NSLocalizedString("NotificationTipsProcessedBody", bundle: Bundle.braveShared, value: "Your monthly tips have been processed!", comment: "Message for monthly tips processed notification")
    public static let NotificationVerifiedPublisherBody = NSLocalizedString("NotificationVerifiedPublisherBody", bundle: Bundle.braveShared, value: "Creator %@ recently verified", comment: "Notification text that tells user which publisher just verified")
    public static let NotificationAutoContributeNotEnoughFundsBody = NSLocalizedString("NotificationAutoContributeNotEnoughFundsBody", bundle: Bundle.braveShared, value: "Your scheduled monthly payment for Auto-Contribute and monthly tips could not be completed due to insufficient funds. We’ll try again in 30 days.", comment: "We show this string in the notification when you don't have enough funds for contribution")
    public static let NotificationContributeTipError = NSLocalizedString("NotificationContributeTipError", bundle: Bundle.braveShared, value: "Unable to send your tip. Please try again later.", comment: "We show this string in notification when tip fails")
    public static let NotificationContributeError = NSLocalizedString("NotificationContributeError", bundle: Bundle.braveShared, value: "There was a problem processing your contribution.", comment: "We show this string in notification when contribution fails")
    public static let NotificationContributeSuccess = NSLocalizedString("NotificationContributeSuccess", bundle: Bundle.braveShared, value: "You've contributed %@ BAT", comment: "We show this string in the notification when contribution is successful")
    public static let NotificationBraveAdsLaunchMsg = NSLocalizedString("NotificationBraveAdsLaunchMsg", bundle: Bundle.braveShared, value: "Now you can earn by viewing ads.", comment: "Message for ads launch notification")
    public static let NotificationContributeNotificationError = NSLocalizedString("NotificationContributeNotificationError", bundle: Bundle.braveShared, value: "There was a problem processing your contribution.", comment: "We show this string in notification when contribution fails")
    public static let NotificationPendingNotEnoughFunds = NSLocalizedString("NotificationPendingNotEnoughFunds", bundle: Bundle.braveShared, value: "You have pending tips due to insufficient funds", comment: "Notification text that tells user his wallet is under funded for pending contribution to complete")
    public static let NotificationInsufficientFunds = NSLocalizedString("NotificationinsufficientFunds", bundle: Bundle.braveShared, value: "Your Brave Rewards account is waiting for a deposit.", comment: "Description for new insufficient funds notification")
    public static let NotificationEarningsClaimDefault = NSLocalizedString("NotificationEarningsClaimDefault", bundle: Bundle.braveShared, value: "Your rewards from Ads are here!", comment: "Panel notification text for Ads grant")
    public static let NotificationGrantNotification = NSLocalizedString("NotificationGrantNotification", bundle: Bundle.braveShared, value: "You have a grant waiting for you.", comment: "Description for new grant notification")
    public static let NotificationErrorTitle = NSLocalizedString("NotificationErrorTitle", bundle: Bundle.braveShared, value: "Uh oh!", comment: "Title for an error notification")
    public static let NoNetworkTitle = NSLocalizedString("NoNetworkTitle", bundle: Bundle.braveShared, value: "Uh oh!", comment: "Title for a no network notification")
    public static let NoNetworkBody = NSLocalizedString("NoNetworkBody", bundle: Bundle.braveShared, value: "The Brave Rewards server is not responding. We will fix this as soon as possible.", comment: "Body for a no network notification")
    public static let MyFirstAdTitle = NSLocalizedString("MyFirstAdTitle", bundle: Bundle.braveShared, value: "This is your first Brave ad", comment: "")
    public static let MyFirstAdBody = NSLocalizedString("MyFirstAdBody", bundle: Bundle.braveShared, value: "Tap here to learn more.", comment: "")
}
