...
extension Strings {
    ...
    public static let googleSafeBrowsing = NSLocalizedString("GoogleSafBrowsing", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Block phishing & Malware with Google Safe Browsing", comment: "")
    public static let googleSafeBrowsingDescription = NSLocalizedString("GoogleSafBrowsingDescription", tableName: "BraveShared", bundle: Bundle.braveShared, value: "This sends URLs of some pages you visit to Brave, when your security is at risk.", comment: "")
