...
extension Strings {
    ...
    public static let HTTPSEverywhereDescription = NSLocalizedString("HTTPSEverywhereDescription", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Opens sites using a secure HTTPS connection instead of plain HTTP.", comment: "")
