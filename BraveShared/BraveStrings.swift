...
extension Strings {
    ...
    public static let googleSafeBrowsing = NSLocalizedString("GoogleSafBrowsing", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Block dangerous sites", comment: "")
    public static let googleSafeBrowsingDescription = NSLocalizedString("GoogleSafBrowsingDescription", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Sends obfuscated URLs of some pages you visit to Brave to check against the Google Safe Browsing service, when your security is at risk.", comment: "")
