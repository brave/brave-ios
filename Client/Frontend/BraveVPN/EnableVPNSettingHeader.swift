...
class EnableVPNSettingHeader: UIView {
  ...
  private let backgroundImage = UIImageView(image: UIImage(named: "enable_vpn_settings_banner", in: .module, compatibleWith: nil)!).then {
    $0.contentMode = .scaleAspectFill
  }

  private let closeButton = UIButton().then {
    $0.setImage(UIImage(named: "card_close", in: .module, compatibleWith: nil)!, for: .normal)
    $0.tintColor = .white
  }
