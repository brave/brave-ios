  ...
  var body: some View {
    VStack(spacing: 16) {
      Button {
        ...
        Image(uiImage: UIImage(named: "privacy-everywhere-exit-icon", in: .module, compatibleWith: nil)!)
      }
      ...
      VStack(spacing: 10) {
        ...
        Image(uiImage: UIImage(named: "privacy-everywhere-image", in: .module, compatibleWith: nil)!)
          .resizable()
