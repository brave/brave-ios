...
class RewardsButton: UIButton {
  ...
  private func updateView() {
    switch iconState {
    case .initial:
      setImage(UIImage(named: "brave_rewards_button_enabled", in: .module, compatibleWith: nil)!, for: .normal)
      lookAtMeBadge.isHidden = false
    case .enabled:
      setImage(UIImage(named: "brave_rewards_button_enabled", in: .module, compatibleWith: nil)!, for: .normal)
      lookAtMeBadge.isHidden = true
    case .disabled:
      setImage(UIImage(named: "brave_rewards_button_disabled", in: .module, compatibleWith: nil)!, for: .normal)
      lookAtMeBadge.isHidden = true
    }
  }
