    ...
    override func willTransition(to newCollection: UITraitCollection, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        coordinator.animate(alongsideTransition: { context in
            ...
            if self.isViewLoaded {
                self.statusBarOverlay.backgroundColor = self.shouldShowTopTabsForTraitCollection(self.traitCollection) ? UIColor.Defaults.GreyH : self.urlBar.backgroundColor
...
extension BrowserViewController: TabTrayDelegate {
    ...
    func tabTrayDidAddBookmark(_ tab: Tab) {
        guard let url = tab.url?.absoluteString, url.count > 0 else { return }
...
extension BrowserViewController: Themeable {
    ...
    func applyTheme(_ theme: Theme) {
        ...
        statusBarOverlay.backgroundColor = shouldShowTopTabsForTraitCollection(traitCollection) ? UIColor.Defaults.GreyI : urlBar.backgroundColor
