...
enum ReaderModeBarButtonType {
    ...
    fileprivate var localizedDescription: String {
        switch self {
        case .settings: return NSLocalizedString("DisplaySettings", value: "Display Settings", comment: "Name for display settings button in reader mode. Display in the meaning of presentation, not monitor.")
        }
    }
