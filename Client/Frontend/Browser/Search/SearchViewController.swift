...
class SearchViewController: SiteTableViewController, KeyboardHelperDelegate, LoaderListener {
    ...
    fileprivate func reloadSearchEngines() {
        ...
        searchButton.accessibilityLabel =
            String(format: NSLocalizedString("SearchSettings", value: "Search Settings", comment: "Label for search settings button."))
        ...
        for engine in quickSearchEngines {
            ...
            engineButton.accessibilityLabel = String(format: NSLocalizedString("Search", value: "%@ search", comment: "Label for search engine buttons. The argument corresponds to the name of the search engine."), engine.shortName)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .searchSuggestions:
            ...
            suggestionCell.imageView?.accessibilityLabel = String(format: NSLocalizedString("SearchSuggestionsFrom", value: "Search suggestions from %@", comment: "Accessibility label for image of default search engine displayed left to the actual search suggestions from the engine. The parameter substituted for \"%@\" is the name of the search engine. E.g.: Search suggestions from Google"), searchEngines.defaultEngine().shortName)
...
fileprivate class SuggestionButton: InsetButton {
    override init(frame: CGRect) {
        ...
        accessibilityHint = NSLocalizedString("SearchesForTheSuggestion", value: "Searches for the suggestion", comment: "Accessibility hint describing the action performed when a search suggestion is clicked")
    }
