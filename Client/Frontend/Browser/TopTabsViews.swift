...
struct TopTabsSeparatorUX {
    ...
    static let Color = UIColor.Defaults.GreyD
...
class TopTabCell: UICollectionViewCell {
    ...
    var selectedTab = false {
        didSet {
            backgroundColor = selectedTab ? UIColor.white : UIColor.Defaults.GreyB
            titleText.textColor = selectedTab ? UIColor.Defaults.GreyJ : UIColor.Defaults.GreyH
            highlightLine.isHidden = !selectedTab
            closeButton.tintColor = selectedTab ? UIColor.Defaults.GreyI : UIColor.Defaults.GreyH
            // restyle if we are in PBM
            if style == .dark && selectedTab {
                backgroundColor =  UIColor.Defaults.GreyH
                titleText.textColor = UIColor.Defaults.GreyA
                closeButton.tintColor = UIColor.Defaults.GreyA
            }
    ...
    let closeButton: UIButton = {
        ...
        closeButton.tintColor = UIColor.Defaults.GreyI
    ...
    let highlightLine: UIView = {
        let line = UIView()
        line.backgroundColor = UIColor.Defaults.Blue
        line.isHidden = true
        return line
    }()
    ...
    fileprivate func applyStyle(_ style: Style) {
        ...
        case Style.light:
            ...
            highlightLine.backgroundColor = UIColor.Defaults.Blue
        case Style.dark:
            titleText.textColor = UIColor.lightText
            backgroundColor = UIColor.Defaults.GreyI
            highlightLine.backgroundColor = UIColor.Defaults.Purple
        }
    }
