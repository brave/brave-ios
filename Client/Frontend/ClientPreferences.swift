...
extension Preferences {
  final public class General {
    ...
    /// Specifies If Automatic Night Mode is enabled
    public static let automaticNightModeEnabled = Option<Bool>(key: "general.automatic-night-mode-enabled", default: false)
