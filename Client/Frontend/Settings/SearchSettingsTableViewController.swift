...
class SearchSettingsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = NSLocalizedString("SettingsSearchNavigationTitle", value: "Search", comment: "Navigation title for search settings.")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == SectionDefault {
            ...
            case ItemDefaultSuggestions:
                ...
                cell.textLabel?.text = NSLocalizedString("ShowSearchSuggestions", value: "Show Search Suggestions", comment: "Label for show search suggestions setting.")
                let toggle = UISwitch()
