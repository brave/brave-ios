...
extension LoginDetailViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .usernameItem:
            ...
            loginCell.highlightedLabelTitle = NSLocalizedString("Username", value: "username", comment: "Label displayed above the username row in Login Detail View.")
        ...
        case .passwordItem:
            let loginCell = dequeueLoginCellForIndexPath(indexPath)
            loginCell.style = .noIconAndBothLabels
            loginCell.highlightedLabelTitle = NSLocalizedString("Password", value: "password", comment: "Label displayed above the password row in Login Detail View.")
        ...
        case .websiteItem:
            let loginCell = dequeueLoginCellForIndexPath(indexPath)
            loginCell.style = .noIconAndBothLabels
            loginCell.highlightedLabelTitle = NSLocalizedString("Website", value: "website", comment: "Label displayed above the website row in Login Detail View.")
        ...
        case .lastModifiedSeparator:
            ...
            let lastModified = NSLocalizedString("LastModified", value: "Last modified %@", comment: "Footer label describing when the current login was last modified with the timestamp as the parameter.")
        ...
        case .deleteItem:
            ...
            deleteCell.textLabel?.text = NSLocalizedString("Delete", value: "Delete", comment: "Label for the button used to delete the current login.")
