...
class SnackBar: UIView {
  ...
  init(text: String, img: UIImage?) {
    ...
    imageView.image = img ?? FaviconFetcher.defaultFaviconImage
    textLabel.text = text
    setup()
  }
...
class TimerSnackBar: SnackBar {
  ...
  static func showAppStoreConfirmationBar(forTab tab: Tab, appStoreURL: URL) {
    let bar = TimerSnackBar(text: Strings.externalLinkAppStoreConfirmationTitle, img: FaviconFetcher.defaultFaviconImage)
