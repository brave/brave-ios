...
extension CreateWalletViewController {
  class View: UIView {
    ...
    private struct UX {
      ...
      static let learnMoreTextColor = RewardsPalette.blue500
    ...
    private let watermarkImageView = UIImageView(image: UIImage(imageLiteralResourceName: "bat-watermark"))
    ...
    private let batLogoImageView = UIImageView(image: UIImage(imageLiteralResourceName: "bat-logo"))
