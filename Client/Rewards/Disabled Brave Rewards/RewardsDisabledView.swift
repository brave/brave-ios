...
extension RewardsDisabledView {
  fileprivate class ContentView: UIView {
    private struct UX {
      ...
      static let subtitleColor = RewardsPalette.blurple400
      static let bodyColor = RewardsPalette.grey100
      static let rewardsButtonTintColor = RewardsPalette.blurple400
      static let rewardsButtonHeight = 40.0
    }
    
    let batLogoImageView = UIImageView(image: UIImage(imageLiteralResourceName: "bat-logo")).then {
