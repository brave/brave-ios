...
class InsufficientFundsButton: UIControl {
  ...
  private struct UX {
    static let backgroundColor = RewardsPalette.blurple000
    static let imageTintColor = RewardsPalette.grey300
  }
  ...
  private let imageView = UIImageView(image: UIImage(imageLiteralResourceName: "icn-frowning-face").alwaysTemplate).then {
