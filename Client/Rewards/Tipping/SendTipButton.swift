...
class SendTipButton: UIControl {
  ...
  private let imageView = UIImageView(image: UIImage(imageLiteralResourceName: "airplane-icn").alwaysTemplate).then {
    $0.tintColor = RewardsPalette.blurple600
  }
  ...
  override init(frame: CGRect) {
    ...
    backgroundColor = RewardsPalette.blurple400
