...
class TippingOverviewView: UIView {
  private struct UX {
    static let backgroundColor = RewardsPalette.blurple800
    static let headerBackgroundColor = RewardsPalette.grey300
    static let headerHeight: CGFloat = 98.0
    static let faviconBackgroundColor = RewardsPalette.neutral800
    static let faviconSize = CGSize(width: 88.0, height: 88.0)
    static let titleColor = RewardsPalette.grey100
    static let bodyColor = RewardsPalette.grey200
  }
  ...
  let watermarkImageView = UIImageView(image: UIImage(imageLiteralResourceName: "tipping-bat-watermark"))
  
  let heartsImageView = UIImageView(image: UIImage(imageLiteralResourceName: "hearts"))
