  ...
  private class HeaderView: UIView {
    ...
    override init(frame: CGRect) {
      ...
      stackView.addStackViewItems(
        .view(UIImageView(image: UIImage(imageLiteralResourceName: "bat-dragable"))),
        .customSpace(20.0),
        .view(UILabel().then {
          $0.textColor = .white
        ...
        .view(UILabel().then {
          $0.textColor = RewardsPalette.blue500
        ...
        .view(UIImageView(image: UIImage(imageLiteralResourceName: "learn-more-arrow").alwaysTemplate).then {
          $0.tintColor = .white
          $0.alpha = 0.5
        })
      )
