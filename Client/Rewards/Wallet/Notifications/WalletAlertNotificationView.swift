...
struct WalletAlertNotification {
  struct Category {
    ...
    static let success = Category(
      icon: UIImage(imageLiteralResourceName: "icn-validated"),
      backgroundImage: UIImage(imageLiteralResourceName: "notification_header_normal")
    )
    static let warning = Category(
      icon: UIImage(imageLiteralResourceName: "icn-warning"),
      backgroundImage: UIImage(imageLiteralResourceName: "notification_header_warning")
    )
    static let error = Category(
      icon: UIImage(imageLiteralResourceName: "icn-error"),
      backgroundImage: UIImage(imageLiteralResourceName: "notification_header_error")
    )
  }
