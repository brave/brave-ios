...
class WalletNotificationView: UIView {
  ...
  let backgroundView = UIImageView(image: UIImage(imageLiteralResourceName: "notification_header"))
  ...
  override init(frame: CGRect) {
    ...
    closeButton.do {
      $0.setImage(UIImage(imageLiteralResourceName: "close-icon").alwaysTemplate, for: .normal)
      $0.tintColor = RewardsPalette.grey300
