...
extension WalletDetailsViewController {
  class View: UIView {
    ...
    init(isEmpty: Bool) {
      ...
      backgroundColor = RewardsSettingsUX.backgroundColor
...
extension WalletDetailsViewController.View {
  ...
  private class PoweredByUpholdView: UIView {
    override init(frame: CGRect) {
      ...
      let upholdImage = UIImage(imageLiteralResourceName: "uphold").alwaysTemplate
      ...
      stackView.addArrangedSubview(UILabel().then {
        ...
        $0.textColor = RewardsPalette.grey300
