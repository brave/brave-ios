...
extension GrantClaimedViewController {
  ...
  private class View: UIView {
    ...
    override init(frame: CGRect) {
      ...
      let imageView = UIImageView(image: UIImage(imageLiteralResourceName: "bat-reward-graphic"))
...
extension GrantClaimedViewController {
  private class InfoView: UIView {
    private struct UX {
      static let infoAccentTextColor = RewardsPalette.magenta300
    }
    ...
    override init(frame: CGRect) {
      ...
      backgroundColor = RewardsPalette.neutral800
