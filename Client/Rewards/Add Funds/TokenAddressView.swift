...
class TokenAddressView: UIView {
  ...
  enum TokenKind {
    ...
    var image: UIImage {
      switch self {
      case .bitcoin:
        return UIImage(imageLiteralResourceName: "token-btc")
      case .basicAttentionToken:
        return UIImage(imageLiteralResourceName: "token-bat")
      case .ethereum:
        return UIImage(imageLiteralResourceName: "token-eth")
      case .litecoin:
        return UIImage(imageLiteralResourceName: "token-ltc")
      }
    }
  ...
  let addressTextView = UITextView().then {
    ...
    $0.isEditable = false
    $0.layer.borderColor = RewardsPalette.grey600.cgColor
