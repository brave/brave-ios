...
class DataManager: NSObject {
    ...
    static func saveContext(context: NSManagedObjectContext?) {
        ...
        if context === DataManager.shared.writeContext {
        ...
        if context.hasChanges {
            do {
                ...
                if context === DataManager.shared.mainThreadContext {
                    ...
                    DataManager.shared._workerContext = nil
                    ...
                    DispatchQueue.main.async {
                        DataManager.shared.writeContext.perform {
                            if !DataManager.shared.writeContext.hasChanges {
                                return
                            }
                            do {
                                try DataManager.shared.writeContext.save()
                            } catch {
                    ...
                    DispatchQueue.main.async {
                        DataManager.saveContext(context: DataManager.shared.mainThreadContext)
                    }
                }
            } catch {
